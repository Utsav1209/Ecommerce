        ...
        <div>
            <nav class="navbar navbar-expand-lg bg-info navbar-light">
                <div class="container-fluid">
                    ...
                    <button class="navbar-toggler" type="button" ng-click="toggleCollapse()" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse" ng-class="{ 'show': isCollapsed }" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="../cart.php"><i class="fa-solid fa-cart-shopping"></i><sup>{{ cartItemCount }}</sup></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#">Total Price: {{ totalCartPrice }} /-</a>
                            </li>
                        </ul>
                        <form class="d-flex" ng-submit="searchProduct()">
                            <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" ng-model="searchData">
